...
// This event is emmited from the child component GoalDetailsComponent and it clears goals if completed
...
// This deletes goals when complited

deleteGoal(isComplete, index){
  if(isComplete){
    let toDelete=confirm(`Are your sure you want delete ${this.goals[index].name}?`);
